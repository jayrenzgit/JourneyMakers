...
const clients = [
  {
    ...
    images: [
      '/JourneyMakers/assets/1/1.jpg',
      '/JourneyMakers/assets/1/2.jpg',
      '/JourneyMakers/assets/1/3.jpg'
    ],
    ...
    videoThumbnail: '/JourneyMakers/assets/1/1.jpg',
  ...
  },
  {
    ...
    images: [
      '/JourneyMakers/assets/2/1.jpg',
      '/JourneyMakers/assets/2/2.jpg'
    ],
    location: 'Dubai International Airport',
    ...
    videoThumbnail: '/JourneyMakers/assets/2/1.jpg',
  ...
  },
  {
    ...
    videoThumbnail: '/JourneyMakers/assets/3/1.jpg',
